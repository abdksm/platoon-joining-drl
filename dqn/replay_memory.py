...
class ReplayMemory(metaclass=ABCMeta):
    ...
    def store_transitions(self, obs, action, rew, done, new_obs):
        """
        ...
        Args:
            ...
            rew: The reward obtained after taking the action
            done: A flag that indicates the end of an episode
            new_obs: The new observation after taking the action 
        """
        raise NotImplementedError

    def sample_transitions(self, step):
        """
        Samples a batch from the replay buffer randomly without replacement
...
class ReplayMemoryNaive(ReplayMemory):
    ...
    def store_transition(self, obs, action, rew, done, new_obs):  
        """
        Inserts the transition at the end of the deque
        """    
    ...
    def sample_transitions(self, step=None):
        """
        Samples a batch randomly from the buffer and without replacement
        """
